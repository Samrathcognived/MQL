...
import {CLINET_ID, CLINET_SECRTE, CODE_VERIFIER_LOCAL_STORAGE_KEY, FHIR_BASE_URL, REDIRECT_URL as REDIRECT_URI, SMART_AUTH_URL, SMART_TOKEN_URL, TOKEN_RESPONSE_LOCAL_STORAGE_KEY} from './config'
...
const  App = () => {
  ...
  const generateRedirectUrl = (codeChallenge) =>{
    ...
    authorizationUrl.searchParams.set('scope', 'openid fhirUser user/Patient.read')
